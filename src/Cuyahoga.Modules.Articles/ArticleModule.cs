...
namespace Cuyahoga.Modules.Articles
{
	...
	/// </summary>
	[Transactional]
	public class ArticleModule : ModuleBase, IActionProvider, INHibernateModule, ISyndicatable
	{
		//private readonly IContentItemService<Article> _contentItemService;
        //private readonly ICategoryService _categoryService;
        //private readonly ICommentService _commentService;

        public IContentItemService<Article> _contentItemService;
        ...
        /// </summary>
        /// <returns></returns>
        public IList<Article> GetFullArticleList()
        {
            return this._contentItemService.FindContentItemsBySection(this.Section);
        }

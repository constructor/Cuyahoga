...
namespace Cuyahoga.Core.DataAccess
{
	...
	public interface IUserDao
	{
        ...
        /// <summary>
        /// Get all users for the given siteId.
        /// </summary>
        /// <param name="user"></param>
        IList<User> GetUsersBySiteID(Int32 siteId);
        ...
        /// Delete site users.
        /// </summary>
        /// <param name="site">The Cuyahoga Site of which all users will be deleted</param>
        void DeleteSiteUsers(Site site);
	}
}

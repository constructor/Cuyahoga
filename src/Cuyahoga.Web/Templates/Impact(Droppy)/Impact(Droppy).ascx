...
<head>
    ...
    <script src="<% =String.Format("{0}Templates/Impact(Droppy)/JavaScript/jquery.js", Cuyahoga.Web.Util.UrlHelper.GetApplicationPath().ToString()) %>" type="text/javascript"></script>
    <script src="<% =String.Format("{0}Templates/Impact(Droppy)/JavaScript/jquery.droppy.js", Cuyahoga.Web.Util.UrlHelper.GetApplicationPath().ToString()) %>" type="text/javascript"></script>
    
    <script src="<% =String.Format("{0}Templates/Impact(Droppy)/JavaScript/page.js", Cuyahoga.Web.Util.UrlHelper.GetApplicationPath().ToString()) %>" type="text/javascript"></script>

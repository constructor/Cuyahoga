		...
		<form id="Form1" method="post" runat="server">
			<div id="moduleadminpane">
				...
				<asp:panel id="pnlIntro" cssclass="group" runat="server" visible="False">
                    ...
                    <br />
                    The installer will first install the database. After 
				...
				<asp:panel id="pnlModules" cssclass="group" runat="server" visible="false">
					...
					<asp:button id="btnInstallModules" runat="server" text="Install selected modules" onclick="BtnInstallModulesClick" />
					<asp:button id="btnSkipInstallModules" runat="server" text="Skip installing optional modules" onclick="BtnSkipInstallModulesClick"  />
				</asp:panel>
				<asp:panel id="pnlAdmin" cssclass="group" runat="server" visible="False">
					<h4>Set administrator password</h4>
                    <br />
                    The default administrator has the username 
				...
				<asp:panel id="pnlCreateSite" cssclass="group" runat="server" visible="False">
					<h4>Create site</h4>
                    <br />
                    Do you want Cuyahoga to create a basic site for you? 
					<br/><br/>

...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <p>Manage the modules that are available for each site to use.</p>
        
		<div id="moduletabs">
	        <ul>
		        <li><a href="#tabs-1">Manage Modules</a></li>
		        <li><a href="#tabs-2">Upload Module Pack</a></li>
	        </ul>
            ...
            <div id="tabs-2">
                ...
                <p>Browse to the module pack file on on your computer and upload.</p>
                ...
                <div class="group">
                    ...
                    <asp:Button ID="btnUpload" runat="server" Text="Upload Module Pack" ValidationGroup="uploader" CausesValidation="true" onclick="btnUpload_Click" />
